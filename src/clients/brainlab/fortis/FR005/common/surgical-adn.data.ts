...
export const surgicalAdnCourses: Course[] = [
  {
    code: "AHP216",
...
export const surgicalAdnIndicators: Indicator[] = [
  {
    sign: "**",
  ...
  },
  {
    sign: "***",
    meaning:
      "Awarding of Academic Credit for Licensed Practical Nurses: Prospective students who have completed a Practical Nursing program and hold a current PN license will be awarded up to 23 quarter credits for these courses in the Nursing program. Prospective students who completed a Practical Nursing program that did not include a course in general informatics will be awarded only 21-quarter credits and will be required to take CMP105 Introduction to Informatics as part of their plan of study.",
  },
  {
    sign: "***",
